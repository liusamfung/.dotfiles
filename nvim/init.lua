...
--]]
vim.opt.wrap = false -- always wrap text (Single line)
...
vim.o.number = true --Imprime el numero de linea donde te encuentras parado actualmente.
...
vim.opt.expandtab = true --convert tables to spaces
...
vim.opt.softtabstop = 2 --number of spaces inserted for <Tab> key amigo mio del español
vim.opt.smartindent = true --enable smart indentation.
vim.opt.spelllang = { 'en', 'es' } -- Agregamos el diccionario para ingles y español.
-- vim.opt.spell = true --Activamos por defecto el spell language.
  ...
  spec = {
...

    {
      ...
      config = function()
        ...
        vim.list_extend(ensure_installed, {
          ...
          'typescript-language-server', --Here you have to put your language servers
    ...
    { -- Collection of various small independent plugins/modules
      ...
      config = function()
        ...
        require('mini.pairs').setup() --Coloca automáticament el cierre de los brackets, comillas, braces, etc.
